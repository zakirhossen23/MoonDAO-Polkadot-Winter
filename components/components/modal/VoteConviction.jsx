				...
				<Container>
					<form id="doanteForm" onSubmit={VoteSubmission} autoComplete="off">
						...
						<div className="voteTypeContainer">
							<button type="button" selected onClick={(e) => { SelectVoteType("aye", e.target) }} className="VoteType">Aye</button>
							<button type="button" onClick={(e) => { SelectVoteType("nay", e.target) }} className="VoteType">Nay</button>
							<button type="button" onClick={(e) => { SelectVoteType("split", e.target) }} className="VoteType">Split</button>
							<button type="button" onClick={(e) => { SelectVoteType("abstain", e.target) }} className="VoteType">Abstain</button>
						</div>
						...
						<DialogActions>
							{Amount <= Balance ? (<><LoadingButton type="submit" name="VoteConvictionBTN" loading={isLoading} className="btn-secondary" size="medium">
								Vote
							</LoadingButton></>) : (<>
